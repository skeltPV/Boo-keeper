...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public boolean addData(String item)
    {
        ...
        //Returns all the data form the database
        ...
        //Returns only the ID that matches the name passed in the @param name
        ...
        public void updateName(String newName, int id, String oldName)
        {
            ...
            Log.d(TAG, "updateName: Setting book name to: " + newName);
            db.execSQL(query);
        }
